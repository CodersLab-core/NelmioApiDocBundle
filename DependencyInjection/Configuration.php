        ...
        $treeBuilder
            ...
            ->children()
                ...
                ->arrayNode('areas')
                    ...
                    ->defaultValue(['default' => ['path_patterns' => [], 'host_patterns' => [], 'namespace_version' => 'v1']])
                    ->beforeNormalization()
                        ->ifTrue(function ($v) {
                            return 0 === count($v) || isset($v['path_patterns']) || isset($v['host_patterns']) || isset($v['namespace_version']);
                        })
                        ->then(function ($v) {
                            return ['default' => $v];
                        })
